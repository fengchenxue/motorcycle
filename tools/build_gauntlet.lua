...
分区(开放式,y=220 平路,全长 ≈3400 studs,巡航 ≈35s):
  ...
  Z4.5 爬墙越顶  左半幅横墙 H24(ADR-47:≥~115 速正面=翻越捷径,巡航=失速滑落;右半幅可绕=ADR-42)
...
do
	...
	local center = cf.Position + cf.RightVector * -10 + Vector3.new(0, 12 - ROAD_DROP, 0)
	local w = mk{ name = "ClimbWall", size = Vector3.new(2, 24, 22), -- H24:≥~115 速可翻(冲刺门),巡航冲顶 ~22<出墙阈 25.6=干净失速(擦顶弹过=摔墙顶,余量必须 ≥3)
