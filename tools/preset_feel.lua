...
v3(人类二轮反馈 2026-07-15"在 hot 基础上改:平地镜头抖动小一些,镜头晃动再平稳一些"):
  hot=工作基线;震动大减+低通软化。steady 保持 v2 原值作 A/B 对照。
v4(人类三轮 2026-07-15/16):相机=人类手调终值(近机位 9/5、慢跟随 YawLag 0.3、侧倾 0.12/低通 0.3、
  冲刺震动回 0.24 平地保持 0.04);**新增 GR2 速度手感(ADR-46)**:Speed_AccelTauSec=0.9 渐近式加速
  (起步/点火都要"爬"上去,越近顶速越慢)+Speed_SteerDragFrac=0.05 转向泄速(压弯掉 5% 回正回升);
  碰撞泄速沿用碰撞三档(GrazeSlowdown/BounceSlowdown 已进 T 面板可调)。
]]
...
local TOUCHED = {
	"Speed_AccelTauSec", "Speed_SteerDragFrac",
