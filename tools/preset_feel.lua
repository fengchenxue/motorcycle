...
local TOUCHED = {
	...
	"Camera_SteerRollGain", "Camera_SteerRollMaxDeg", "Camera_FOVSpeedGain",
...
local OVERRIDES = {
	...
	steady = {
		...
		Camera_SteerRollGain = 0.35, Camera_SteerRollMaxDeg = 10, Camera_FOVSpeedGain = 0.08,
	...
	hot = {
		...
		Camera_FollowLagSec = 0.05, Camera_YawLagSec = 0.08,
		Camera_FOVBase = 80, Camera_FOVSprint = 97, Camera_FlowFOV = 103, Camera_FOVLerpSec = 0.12,
		Camera_ShakeSprint = 0.25, Camera_ShakeFreqHz = 14,
		Camera_SteerRollGain = 0.45, Camera_SteerRollMaxDeg = 12, Camera_FOVSpeedGain = 0.10,
		Camera_FOVPunchDeg = 6, Camera_FOVPunchDecaySec = 0.30,
		Camera_LandDipPerVy = 0.008, Camera_LandDipMax = 1.4,
		Camera_ShakeSpeedGain = 0.12, Camera_AirPitchDownDeg = 5, Camera_AirPitchLerpSec = 0.20,
